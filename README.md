...
different room features and room availability. It is a menu driven program and it runs until
...
that when we restart the program, the old details are not lost. User defined exception is thrown if the user
